...
if ('undefined' === typeof Ember) {
  ...
  */
  ...
  // Ember depends on 'window', which is defined in the browser but not in
  // server environments such as NodeJS.
  // If 'window' is undefined, create it, pointing to the root object in
  // the JavaScript runtime (in NodeJS it is named 'global')
